...
CREATE OR REPLACE USER PYSPARK_USER_{{ env | upper }}
    DEFAULT_ROLE      = SNOWPIPE_STREAMING_INGEST_ROLE_{{ env | upper }}
    DEFAULT_WAREHOUSE = STREAMING_PIPE_WH_{{ env | upper }}
    MUST_CHANGE_PASSWORD = FALSE;

GRANT ROLE SNOWPIPE_STREAMING_INGEST_ROLE_{{ env | upper }}
